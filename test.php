...
if (isset($_POST['header'])) {
    ...
    $vals[] = "report-uri http://127.0.0.1:8080/report.php;";
    $csp = '';
...
<body>
    <form method="POST" id="form">
        ...
        <textarea rows="8" cols="90" name='header'><?php if (isset($_POST['header'])) echo ($_POST['header']); ?></textarea>

        <h3>Tag Head (es: &lt;script nonce='AABBCCDD'&gt;foo(); &lt;/script&gt;)</h3>
        <textarea rows="8" cols="90" name='head'><?php if (isset($_POST['head'])) echo ($_POST['head']); ?></textarea>

        <h3>Tag Body (Some html tag)</h3>
        <textarea rows="8" cols="90" name='body'><?php if (isset($_POST['body'])) echo ($_POST['body']); ?></textarea>
        <br>
